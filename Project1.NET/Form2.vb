...
Friend Class Form2
	...
	Public Sub HIDE_HELP_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HIDE_HELP.Click
	...
	Private Sub Command1_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command1.Click
		...
		If Adodc1.Recordset.EOF Then
			...
			Beep_Renamed(500, 500)
			MsgBox("ERROR, CHECK USERNAME AND PASSWORD THEN RETRY", MsgBoxStyle.Critical, "CREDENTIAL ERROR")
			Beep_Renamed(8000, 100)
			Text1.Text = ""
			Text2.Text = ""
			Text4.Text = ""
	...
	Private Sub Command2_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command2.Click
		...
		Else
			Beep_Renamed(500, 500)
			Beep_Renamed(500, 500)
			MsgBox("ERROR, PRODUCT KEY THEN RETRY", MsgBoxStyle.Critical, "PRODUCT KEY ERROR")
			Beep_Renamed(8000, 100)
			Text4.Text = ""
			Timer1.Interval = 10
			Timer1.Enabled = True
	...
	Private Sub Command29_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command29.Click
		Beep_Renamed(8000, 100)
		MsgBox("LOGING OUT", MsgBoxStyle.Information, "CLOSING")
		Beep_Renamed(8000, 100)
		End
	End Sub
	...
	Private Sub Command3_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command3.Click
		...
		If Text5.Text = Text And Text6.Text = Text Then
			Beep_Renamed(500, 500)
			Beep_Renamed(500, 500)
			MsgBox("ERROR, TYPE IN NEW USER NAME AND NEW PASSWORD BEFORE SAVING", MsgBoxStyle.Critical, "INPUT ERROR")
			Beep_Renamed(8000, 100)
		Else
			With Adodc2.Recordset
				Timer1.Interval = 10
	...
	Public Sub SHOW_HELP_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles SHOW_HELP.Click
		Beep_Renamed(8000, 100)
