...
Friend Class Form14
	...
	Public Sub COLLER_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles COLLER.Click
	...
	Public Sub COPIER_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles COPIER.Click
		Beep_Renamed(8000, 100)
		r = CDbl(Text1.Text)
	End Sub
	
	Public Sub SCIENTIFIQUE_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles SCIENTIFIQUE.Click
		Beep_Renamed(8000, 100)
		Me.Width = VB6.TwipsToPixelsX(6580)
		Text1.Width = VB6.TwipsToPixelsX(5950)
		Text2.Width = VB6.TwipsToPixelsX(5950)
		Text3.Width = VB6.TwipsToPixelsX(5950)
	End Sub
	...
	Public Sub STANDARD_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles STANDARD.Click
		...
		Text1.Width = VB6.TwipsToPixelsX(3950)
		Text2.Width = VB6.TwipsToPixelsX(3950)
		Text3.Width = VB6.TwipsToPixelsX(3950)
	End Sub
End Class