...
Friend Class Form7
	...
	Public Sub importimage()
		With Adodc1.Recordset
			...
			If Dir(My.Application.Info.DirectoryPath & "\images\" & Trim(.Fields("NUM_CLIENT").Value) & ".jpg") <> "" Then
				Image1.Image = System.Drawing.Image.FromFile(My.Application.Info.DirectoryPath & "\images\" & Trim(.Fields("NUM_CLIENT").Value) & ".jpg")
			Else
