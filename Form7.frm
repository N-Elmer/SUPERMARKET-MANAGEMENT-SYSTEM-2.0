...
Timer1.Interval = 30
Timer1.Enabled = True
Adodc1.RecordSource = "select * from CLIENT where NOM_CLIENT like '%" & (Text3.Text) & "%'"
...
With Adodc1.Recordset
.Find "NUM_CLIENT='" & Text1.Text & "'"
If Dir$(App.Path & "\images\" & Trim(!NUM_CLIENT) & ".jpg") <> "" Then
Set Image1.Picture = LoadPicture(App.Path & "\images\" & Trim(!NUM_CLIENT) & ".jpg")
Else
