...
Begin VB.Form Form9 
   ...
   Begin VB.Frame Frame9 
      ...
      Begin VB.TextBox Text4 
         Alignment       =   2  'Center
         DataField       =   "TEMPS_ENREGISTREMENT"
         BeginProperty DataFormat 
            Type            =   1
            Format          =   "h:mm:ss AMPM"
            HaveTrueFalseNull=   0
   ...
   Begin VB.Frame Frame7 
      ...
      Begin VB.TextBox Text3 
         Alignment       =   2  'Center
         DataField       =   "QUANTITE_ENREGISTREMENT"
         DataSource      =   "Adodc1"
         BeginProperty Font 
            Name            =   "Times New Roman"
            Size            =   12
